...
def p_bloco(p):
    ...
    bloco : OP_PRIO_ABRE_CHAVES declaracoes OP_PRIO_FECHA_CHAVES
          ...
          | OP_PRIO_ABRE_CHAVES KRINT param_cond OP_PRIO_FECHA_CHAVES
          | OP_PRIO_ABRE_CHAVES param_cond KRINT OP_PRIO_FECHA_CHAVES
          | OP_PRIO_ABRE_CHAVES KRINT expr OP_PRIO_FECHA_CHAVES

          | OP_PRIO_ABRE_CHAVES operacoes OP_PRIO_FECHA_CHAVES
          | bloco bloco
    '''
...
def p_declaracao_atribuicaoValorVariavel(p):
    '''
    declaracao : VARIAVEL OP_ATRIB_IGUAL expr
               | VARIAVEL OP_ATRIB_IGUAL STRING
               | VARIAVEL OP_ATRIB_IGUAL VARIAVEL
               | VARIAVEL OP_ATRIB_IGUAL INTEIRO
               | VARIAVEL OP_ATRIB_IGUAL DOUBLE
               | VARIAVEL OP_ATRIB_IGUAL funcao
               | param VARIAVEL OP_ATRIB_IGUAL INTEIRO
...
def p_KRINT(p):
    '''print : KRINT expr
             | KRINT expr OP_PRIO_ABRE_PARENTESES STRING OP_EXEC_VIRGULA VARIAVEL OP_PRIO_FECHA_PARENTESES
             | KRINT OP_PRIO_ABRE_PARENTESES STRING OP_PRIO_FECHA_PARENTESES
             | KRINT OP_PRIO_ABRE_PARENTESES  STRING OP_EXEC_VIRGULA VARIAVEL OP_PRIO_FECHA_PARENTESES
             | KRINT OP_PRIO_ABRE_PARENTESES  operacoes OP_PRIO_FECHA_PARENTESES
             | KRINT OP_PRIO_ABRE_PARENTESES  VARIAVEL OP_PRIO_FECHA_PARENTESES
    '''

def p_KINPUT(p):
    '''input : VARIAVEL OP_ATRIB_IGUAL KINPUT OP_PRIO_ABRE_PARENTESES expr OP_PRIO_FECHA_PARENTESES
               | VARIAVEL OP_ATRIB_IGUAL param OP_PRIO_ABRE_PARENTESES KINPUT OP_PRIO_ABRE_PARENTESES STRING OP_PRIO_FECHA_PARENTESES OP_PRIO_FECHA_PARENTESES
               | VARIAVEL OP_ATRIB_IGUAL KINPUT OP_PRIO_ABRE_PARENTESES STRING OP_PRIO_FECHA_PARENTESES 
               | VARIAVEL OP_ATRIB_IGUAL KINPUT OP_PRIO_ABRE_PARENTESES STRING VARIAVEL OP_PRIO_FECHA_PARENTESES 
    '''

...
def p_statement_condicionais(p):
    ...
    statement : KIF OP_PRIO_ABRE_PARENTESES cond_param OP_PRIO_FECHA_PARENTESES OP_PRIO_ABRE_CHAVES statements OP_PRIO_FECHA_CHAVES
            ...
            | KIF OP_PRIO_ABRE_PARENTESES cond_param OP_PRIO_FECHA_PARENTESES OP_PRIO_ABRE_CHAVES statements OP_PRIO_FECHA_CHAVES senaose ELSE OP_PRIO_ABRE_CHAVES statements OP_PRIO_FECHA_CHAVES
            | KIF OP_PRIO_ABRE_PARENTESES cond_param OP_PRIO_FECHA_PARENTESES OP_PRIO_ABRE_CHAVES statements OP_PRIO_FECHA_CHAVES ELSE OP_PRIO_ABRE_CHAVES statements OP_PRIO_FECHA_CHAVES
    '''
...
class Application():
    ...
    def chama_analisador(self):
        ...
        for tok in lexer:
            ...
            elif tok.type == "IF" or tok.type == "KELIF" or tok.type == "KELSE" or tok.type == "KWHILE" or tok.type == "KOR" or tok.type == "KT" or tok.type == "KF" or tok.type == "KRINT" or tok.type == "KINPUT":
                max = (len(tok.value))
                if (max < 20):

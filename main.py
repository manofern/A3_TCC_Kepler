...
def p_declaracao_KOR(p):
    ...
    declaracao : KOR VARIAVEL KIN KRANGE OP_PRIO_ABRE_PARENTESES INTEIRO OP_EXEC_VIRGULA INTEIRO OP_PRIO_FECHA_PARENTESES bloco
               ...
               | KOR VARIAVEL KIN KRANGE OP_PRIO_ABRE_PARENTESES INTEIRO OP_PRIO_FECHA_PARENTESES bloco
               | KOR VARIAVEL KIN KRANGE OP_PRIO_ABRE_PARENTESES DOUBLE OP_PRIO_FECHA_PARENTESES bloco
    '''
